...
constexpr lightseq::cuda::OperationType transformer_optytpe = lightseq::cuda::OperationType::FP16;

// const lightseq::cuda::OperationType transformer_optytpe = lightseq::cuda::OperationType::FP32;
...
class Transformer : public LSModel {
 ...
 public:
  ...
  void Infer(int infer_mode) override;
